...
export default class AddDesignation extends Component {
  ...
  componentDidMount(){
    if(this.state.design !== " "){
      axios.get('/designation/find/'+this.state.design).then(response => {
          this.setState({
  ...
  addDesignation(designation){
    axios.post(`/designation/create`, designation ,
    {
  ...
  editDesignation(designation){
    ...
    axios.patch(`/designation/update/`+this.state.design, designation ,
    {
      'Content-type':'application/json'
    }).then(res => {
