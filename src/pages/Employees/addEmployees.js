        ...
        return (
            <div className='main'>
                ...
                <Form onSubmit={this.handleSubmit}>
                    ...
                    <Form.Group className="mb-3">
                        <select className="form-control" name="comp_id" value={this.state.comp_id} onChange={this.handleChange}>
                    ...
                    <Form.Group className="mb-3">
                        <select className="form-control" name="user_id" value={this.state.user_id} onChange={this.handleChange}>
                    ...
                    <Form.Group className="mb-3">
                        <select className="form-control" name="desig_id" value={this.state.desig_id} onChange={this.handleChange}>
                    ...
                    <Form.Group className="mb-3">
                        <select className="form-control" name="dept_id" value={this.state.dept_id} onChange={this.handleChange}>
                            <option >Select</option>
